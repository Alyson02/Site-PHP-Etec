                ...
                <form method="post" action="insprod.php" name="incluiProd" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sltcat">
                            ...
                            <option value="<?php echo $listaCat['cd_categoria']; ?>">
                                <?php echo $listaCat['ds_categoria']; ?></option>
                            <?php } ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="sltautor">
                            ...
                            <option value="<?php echo $listaAutor['cd_autor']; ?>">
                                <?php echo $listaAutor['nm_autor']; ?></option>
                            <?php } ?>
                        </select>
